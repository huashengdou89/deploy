...
#################################################
#需要安装产品列表,可选值"DTS PFS JPOSBO CARD CARDSERVER OTTER HDPOS4 REST PASOREPORT JCRM AZKABAN IA CABLE",一定要大写,注意空格
LIST="DTS PFS JPOSBO CARD CARDSERVER CABLE HDPOS4 REST PASOREPORT JCRM AZKABAN IA OTTER"
