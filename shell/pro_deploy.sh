...
#################################################
#需要安装产品列表,可选值"ADI DTS PFS JPOSBO CARD CARDSERVER OTTER HDPOS4 REST PASOREPORT JCRM AZKABAN IA CABLE PANTHER PANTHERTASK",一定要大写,注意空格
